...
- **روابط استيراد المزوّدين** — يمكن لمواقع المزوّدين أو لوحاتهم فتح AQBot عبر رابط `aqbot://` وملء الاسم و Base URL ومفتاح API ونوع المزوّد بعد تأكيد المستخدم. راجع [إعداد المزوّدين](./guide/providers).
