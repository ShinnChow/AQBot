...
- **Ссылки импорта провайдеров** — Сайты или панели провайдеров могут открывать AQBot через ссылку `aqbot://` и после подтверждения пользователя заполнять имя, Base URL, API-ключ и тип провайдера. См. [Настройка провайдеров](./guide/providers).
